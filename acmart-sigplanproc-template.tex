...
\newline
\indent Therefore, in order to convey a complete and intuitive picture of a system more quickly than text-based methods, we developed an interactive CodeQL sisualization tool for Visual Studio Code, which provides visualization functionalities for data-flow analysis of CodeQL.
%% Bibliography
